$(document).ready(function(){
    ...
    $.getJSON('./model/data.json', function(json0bj){
        ...
        $('#x3dModelTitle_coke').html('<h2>' + json0bj.pageTextData[4].x3dModelTitle + '</h2>');
        $('#x3dCreationMethod_coke').html('<p>' + json0bj.pageTextData[4].x3dCreationMethod + '</p>');
        ...
        $('#x3dModelTitle_sprite').html('<h2>' + json0bj.pageTextData[5].x3dModelTitle + '</h2>');
        $('#x3dCreationMethod_sprite').html('<p>' + json0bj.pageTextData[5].x3dCreationMethod + '</p>');
        ...
        $('#x3dModelTitle_pepper').html('<h2>' + json0bj.pageTextData[6].x3dModelTitle + '</h2>');
        $('#x3dCreationMethod_pepper').html('<p>' + json0bj.pageTextData[6].x3dCreationMethod + '</p>');
